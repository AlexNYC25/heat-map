...
.then(data => {
    ...
    const yScale = d3.scaleLinear()
        .domain([0,11]) 
        .range([10, GRAPH_HEIGHT - GRAPH_PADDING - BAR_HEIGHT]);
    ...
    const xAxis = d3.axisBottom(xScale).ticks(20, '.5');
    const yAxis = d3.axisLeft(yScale)
        .tickFormat(x => formatMonth(parseMonth(x + 1)));
